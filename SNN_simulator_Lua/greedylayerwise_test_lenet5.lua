...
mnist_train[1] = mnist_train[1]:reshape(torch.LongStorage({60000, 1, 28, 28})):double():narrow(1, 1, trainN)
...
--conv1:add(nn.Reshape(1, inSide, inSize))
